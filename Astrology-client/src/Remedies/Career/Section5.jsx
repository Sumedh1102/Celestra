...
const [currentStep, setCurrentStep] = useState(1)
  ...
  return (
      ...
      style={{
        backgroundImage: `url('https://i.pinimg.com/736x/86/89/d0/8689d02ae985c62076c9d728d6191cc4.jpg')`,
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 space-y-8 min-h-screen pt-28">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl md:text-6xl font-light text-orange-500 font-cinzel">Our Consultancy Process</h1>
        ...
        {currentStepData && (
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* Content Section */}
            <div className="bg-transparent border-2 border-orange-600">
              <div className="p-8 flex flex-col justify-center space-y-4 h-full">
                <div className="space-y-2">
                  <h2 className="text-2xl font-medium text-orange-600 font-cinzel">{currentStepData.title}</h2>
                ...
                <div className="flex justify-between pt-6">
                  <button
                    ...
                    className="inline-flex items-center space-x-2 bg-orange-400 hover:bg-orange-400 disabled:bg-orange-400 disabled:cursor-not-allowed px-4 py-2 text-sm font-medium text-white border-2 border-white transition-colors"
                  >
          ...
          {steps.map((step) => (
            <div
              ...
              className={`bg-zinc-50 backdrop-blur-sm rounded-lg cursor-pointer transition-all duration-200 shadow-lg hover:shadow-xl ${
                currentStep === step.id ? "ring-2 ring-orange-800" : ""
              }`}
