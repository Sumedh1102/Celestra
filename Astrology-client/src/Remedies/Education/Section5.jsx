...
const [currentStep, setCurrentStep] = useState(1)
  ...
  return (
      ...
      style={{
        backgroundImage: `url('https://i.pinimg.com/736x/c3/ee/ae/c3eeaee5ee30eb8aa578e013f87bf029.jpg')`,
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 space-y-8 min-h-screen pt-28">
        ...
        {currentStepData && (
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* Content Section */}
            <div className="bg-transparent border-2 border-blue-800">
              <div className="p-8 flex flex-col justify-center space-y-4 h-full">
                ...
                <div className="flex justify-between pt-6">
                  <button
                    ...
                    className="inline-flex items-center space-x-2 bg-blue-300 hover:bg-blue-300 disabled:bg-blue-300 disabled:cursor-not-allowed px-4 py-2 text-sm font-medium text-white border-2 border-white transition-colors"
                  >
          ...
          {steps.map((step) => (
            <div
              ...
              className={`bg-zinc-50 backdrop-blur-sm rounded-lg cursor-pointer transition-all duration-200 shadow-lg hover:shadow-xl ${
                currentStep === step.id ? "ring-2 ring-blue-800" : ""
              }`}
